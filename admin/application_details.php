 ...
 <div class="container_margin">
	<?php
	 ...
	 <?php
	  ...
	  <button id="approved" class="ui positive button" onclick="approve()" value="<?php echo($application_id) ?>">Approve</button>
	   <button id="rejected" class="ui negative button" onclick="decline()" value="<?php echo($application_id) ?>">Reject</button>
