    ...
    <?php
      ...
      if(isset($_GET["admin_id"]) && isset($_GET["name"])){
      $user_name = $_GET["name"];
...
<div class="ui centered card">
  ...
  <div class="content">
    ...
    <?php
        ...
        if(date('m') == 1){
          $query = "SELECT * FROM admin_history WHERE user_id='$user_id' AND YEAR(DATE_SUB(CURDATE(), INTERVAL 1 YEAR))  ORDER BY apply_time DESC";
        }else{
          $query = "SELECT * FROM admin_history WHERE user_id='$user_id' AND YEAR(from_date)=YEAR(CURDATE())  ORDER BY apply_time DESC";
        }
    ...
    <tbody>
      ...
      ?>
        ...
        <tr>
          ...
          <td><a href="application_details.php?application_id=<?php echo $application_id; ?>&admin=true">details</a></td>
