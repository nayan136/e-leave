...
function PageBody(){
  ...
  $this->Ln(5);
  $this->Cell(200,10,'List of Heads',0,0,'C');
  $this->Ln(10);
}
...
function LoadData($conn)
{
    ...
    while($row = mysqli_fetch_assoc($result)){
      ...
      $temp_array = array();
      array_push($temp_array, $i, $department, $name, $username, $employee);
  ...
  $pdf->AliasNbPages();
  // Column headings
  $header = array("Sl No.","Department","Name","Username","No. Of Employee");
  // Data loading
